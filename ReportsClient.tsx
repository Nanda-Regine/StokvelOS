...
import { AnnualGrid }      from '@/components/reports/AnnualGrid'
import { ComplianceDonut } from '@/components/reports/ComplianceDonut'
...
const MonthlyChart = dynamic(
  () => import('@/components/reports/MonthlyChart').then(m => m.MonthlyChart),
